...
/**
 * display information for the selected students
 */
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(lblNewLabel_2, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 258,
										Short.MAX_VALUE)))
				.addContainerGap(104, Short.MAX_VALUE)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup().addGap(34).addComponent(lblNewLabel).addGap(18)
						.addComponent(lblNewLabel_1).addGap(18).addComponent(lblNewLabel_2).addGap(18)
						.addComponent(lblNewLabel_3).addContainerGap(102, Short.MAX_VALUE)));
