						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGap(13)))
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(RentDate, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
								.addComponent(StudentName, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
								.addComponent(StudentNumber, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE))
							.addPreferredGap(ComponentPlacement.RELATED)
