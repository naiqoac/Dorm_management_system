			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
							...
							.addGroup(groupLayout.createSequentialGroup()
								...
								.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
									...
									.addComponent(lblNewLabel_4, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
									.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createSequentialGroup()
								.addGap(33)
								.addComponent(lblNewLabel_1, GroupLayout.PREFERRED_SIZE, 311, GroupLayout.PREFERRED_SIZE))
							.addGroup(groupLayout.createSequentialGroup()
								.addGap(31)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(29)
							.addComponent(lblNewLabel_15, GroupLayout.PREFERRED_SIZE, 324, GroupLayout.PREFERRED_SIZE)))
